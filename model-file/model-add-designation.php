<div class="modal fade" id="model-add-designation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <hr>
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <input class=" form-control" id="ref_desig" name="ref_desig" minlength="2" type="text" required placeholder="Réference" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cname" class="control-label col-lg-4">Désignation (<span class="text-danger">*</span>)</label>
                            <div class="col-lg-8">
                              <input class=" form-control" id="lib_desig" name="lib_desig" minlength="2" type="text" required placeholder="Désignation" />
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btn_add_design" onclick="add_designation()" data-dismiss="modal" class="btn btn-primary">Ajouter</button>
                </div>
          </div>
      </div>
</div>